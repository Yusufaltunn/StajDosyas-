...
public class JobAdvertisementManager implements JobAdvertisementService {
	...
	public Result add(CreateJobAdvertisementRequest createJobAdvertisementRequest) {
		JobAdvertisement jobAdvertisement = this.modelMapperService.forRequest()
				.map(createJobAdvertisementRequest,
						JobAdvertisement.class);
						jobAdvertisement.setId(jobAdvertisement.getId());
						jobAdvertisement.setJobPositions(jobAdvertisement.getJobPositions());
	...
	public Result delete(DeleteJobAdvertisementRequest deleteJobAdvertisementRequest) {
		JobAdvertisement jobAdvertisement = this.modelMapperService.forRequest()
				.map(deleteJobAdvertisementRequest, JobAdvertisement.class);
	...
	public Result update(@RequestBody UpdateJobAdvertisementRequest updateJobAdvertisementRequest) {
		JobAdvertisement jobAdvertisement = this.modelMapperService.forRequest()
				.map(updateJobAdvertisementRequest, JobAdvertisement.class);
		this.jobAdvertisementDao.save(jobAdvertisement);
